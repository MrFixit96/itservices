...
{
    # Show the form
    print "<a href=\"", $request->url(), "?action=View\">View Service Requests</a>"," <a href=../../services/index.php?Department=25>Back To IT Services Home</a>";
    print $request->hr;
...
if ($name eq ""){
   print "<a href= ../../services/index.php?Department=25>Back To IT Services Home</a> "," <a href=\"", $request->url(), "?action=post\">Post Another Request</a>", "<br />" ;
...
########Submit data to the database via sql
    ...
    print $request->p();
    print "<a href= ../../services/index.php?Department=25>Back To IT Services Home</a> "," <a href=\"", $request->url(), "?action=post\">Post Another Request</a>";
}
#########################################################################################
#	update_entry									#
#########################################################################################
...
########Submit data to the database via sql
    ...
    print "Thank you for your $owner\'s Request\.";
    print $request->p();
    print "<a href=../../services/index.php?Department=25>Back To IT Services Home</a> "," <a href=\"", $request->url(), "?action=View\">Public View</a> "," <a href=\"", $request->url(), "?action=Kbase\">Closed Records</a>" ;
}
#########################################################################################
...
# Fetch the contents of the requests
    ...
    print "<a href=\"", $request->url(), "?action=post\">Post a Request</a> "," <a href=\"", $request->url(), "?action=Edit\">Admin View</a> "," <a href=../../services/index.php?Department=25>Back To IT Services Home</a>" ;
    print $request->hr;
    print $request->p();
    print $request->start_table();
